...
export const handler = async (event) => {
  try {
    const queueUrl = "https://sqs.us-east-2.amazonaws.com/471112704621/brendan4-net1500-queue";
    const params = {
      QueueUrl: queueUrl,
    ...
    const command = new SendEmailCommand({
      Destination: {
        ToAddresses: ["BPMulkey01@indianatech.net"],
      },
      Message: {
        Body: {
          Html: { Data: emailbody },
      ...
      Source: "BPMulkey01@indianatech.net",
    });
    let response = await ses.send(command);

    const deleteParams = {
      QueueUrl: "https://sqs.us-east-2.amazonaws.com/471112704621/brendan4-net1500-queue",
